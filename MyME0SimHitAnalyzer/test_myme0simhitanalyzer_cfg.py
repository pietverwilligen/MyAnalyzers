...
process.load("Test_MinBias_Phase1_14TeV_TuneCP5_1M_Neutron_XS_2023DB_1E4s")
...
process.demo = cms.EDAnalyzer('MyME0SimHitAnalyzer',
                              ...
                              PdfFileNameBase = cms.untracked.string("Test_MyME0Histograms_2023DB_TuneCP5_14TeV_Neutron_XS_1M__150eV_v2"),
                              RootFileName = cms.untracked.string("Test_MyME0Histograms_2023DB_TuneCP5_14TeV_Neutron_XS_1M_150eV_v2.root"),
                              # ---------
