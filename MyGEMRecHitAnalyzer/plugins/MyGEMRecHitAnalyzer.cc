// -*- C++ -*-
//
// Package:    MyGEMRecHitAnalyzer
// Class:      MyGEMRecHitAnalyzer
// 
/**\class MyGEMRecHitAnalyzer MyGEMRecHitAnalyzer.cc MyAnalyzers/MyGEMRecHitAnalyzer/src/MyGEMRecHitAnalyzer.cc
...
class MyGEMRecHitAnalyzer : public edm::EDAnalyzer {
   public:
      explicit MyGEMRecHitAnalyzer(const edm::ParameterSet&);
      ~MyGEMRecHitAnalyzer();
...
//
MyGEMRecHitAnalyzer::MyGEMRecHitAnalyzer(const edm::ParameterSet& iConfig)
...
MyGEMRecHitAnalyzer::~MyGEMRecHitAnalyzer()
{
  ...
  GE1in_Plus_XY_All->GetXaxis()->SetTitle("X [cm]");  GE1in_Plus_XY_All->GetYaxis()->SetTitle("Y [cm]");   GE1in_Plus_XY_All->SetTitle("GE+1 RecHits"); 
  ...
  GE1_Minus_YZ_All->SetMarkerStyle(0);   GE1_Minus_YZ_All->SetMarkerColor(0);  GE1_Minus_YZ_All->Draw("AP");   GE1_Minus_YZ_All->GetXaxis()->SetTitle("Z [cm]");   GE1_Minus_YZ_All->GetYaxis()->SetTitle("R [cm]");    GE1_Minus_YZ_All->SetTitle("GE-1 RecHits"); 
...
void
MyGEMRecHitAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
MyGEMRecHitAnalyzer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
MyGEMRecHitAnalyzer::endJob() 
{
}

// ------------ method called when starting to processes a run  ------------
void 
MyGEMRecHitAnalyzer::beginRun(edm::Run const& iRun, edm::EventSetup const& iSetup)
{
...
/*
void 
MyGEMRecHitAnalyzer::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
MyGEMRecHitAnalyzer::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
MyGEMRecHitAnalyzer::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
MyGEMRecHitAnalyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MyGEMRecHitAnalyzer);
