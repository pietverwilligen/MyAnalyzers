...
void Compare_STAMuonHits_Segments_2015vs2023() {
    ...
    // Filename base
    // -------------
    std::string Histo_RPCb = "SegmentsAndHits/Rechits_All_Eta_1D";
    std::string Histo_RPCf = "SegmentsAndHits/Rechits_RPC_Eta_1D";
    std::string Histo_CSC  = "SegmentsAndHits/Rechits_CSC_Eta_1D";
    std::string Histo_DT   = "SegmentsAndHits/Rechits_DT_Eta_1D";
    ...
    */
    ...
    std::stringstream pdfname2ss; pdfname2ss<<"Compare_STAMuonHits_Segments_"<<title<<"_All"; std::string pdfname2 = pdfname2ss.str(); 
    ...
    std::stringstream pdfname3ss; pdfname3ss<<"Compare_STAMuonHits_Segments_"<<title<<"_RPC"; std::string pdfname3 = pdfname3ss.str(); 
    ...
    std::stringstream pdfname4ss; pdfname4ss<<"Compare_STAMuonHits_Segments_"<<title<<"_DT"; std::string pdfname4 = pdfname4ss.str(); 
    ...
    std::stringstream pdfname5ss; pdfname5ss<<"Compare_STAMuonHits_Segments_"<<title<<"_CSC"; std::string pdfname5 = pdfname5ss.str(); 
