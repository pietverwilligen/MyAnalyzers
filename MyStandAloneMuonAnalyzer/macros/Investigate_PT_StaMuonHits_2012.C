...
void Investigate_PT_StaMuonHits_2012() {
    ...
    y_range_2 = 0.30;    
    std::stringstream pdfname1ss; pdfname1ss<<"STAMuonPtSpectrum_2012_"<<"StaMuInvestigation"<<"_Lin"; std::string pdfname1 = pdfname1ss.str(); 
    ...
    latex_cmslab.DrawLatex(0.05, 0.925,"CMS #sqrt{s} = 8 TeV"); latex_cmslab.DrawLatex(0.70, 0.925, "Stand Alone Muons"); gPad->RedrawAxis(); latex_cmslab.DrawLatex(0.125, 0.85, "All");
    ...
    y_range_2 = 1.00;
    std::stringstream pdfname2ss; pdfname2ss<<"STAMuonPtSpectrum_2012_"<<"StaMuInvestigation"<<"_Log"; std::string pdfname2 = pdfname2ss.str(); 
