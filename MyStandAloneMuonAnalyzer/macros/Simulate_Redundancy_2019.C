...
void Simulate_Redundancy_2019() {
    ...
    // Main Comparison
    // ---------------
    std::string label2 = "CMSSW 62X SLHC (2019 Geometry)"; 
    ...
    // Filename hardcoded
    // ------------------
    std::string RootFileName2 = "STAMuon_62X_2019.root";
    ...
    */
    ...
    std::stringstream pdfname2ss; pdfname2ss<<"STAMuonHits_2D_2019_"<<"RedPercent"<<"_All"; std::string pdfname2 = pdfname2ss.str(); 
    ...
    /*
    y_range_2 = 10.00;
    std::stringstream pdfname3ss; pdfname3ss<<"STAMuonHits_2D_2019_"<<"RedPercent"<<"_RPC"; std::string pdfname3 = pdfname3ss.str(); 
    ...
    y_range_2 = 10.00;
    std::stringstream pdfname4ss; pdfname4ss<<"STAMuonHits_2D_2019_"<<"RedPercent"<<"_DT"; std::string pdfname4 = pdfname4ss.str(); 
    ...
    y_range_2 = 10.00;
    std::stringstream pdfname5ss; pdfname5ss<<"STAMuonHits_2D_2019_"<<"RedPercent"<<"_CSC"; std::string pdfname5 = pdfname5ss.str(); 
    ...
    */
    ...
    std::stringstream pdfname6ss; pdfname6ss<<"STAMuonHits_2D_2019_"<<"GradualEfficiency"<<"_All"; std::string pdfname6 = pdfname6ss.str();
    ...
    std::stringstream pdfname7ss; pdfname7ss<<"STAMuonHits_2D_2019_"<<"GradualEfficiency"<<"_All_v2"; std::string pdfname7 = pdfname7ss.str();
    ...
    std::stringstream pdfname8ss; pdfname8ss<<"STAMuonHits_2D_2019_"<<"GradualEfficiency"<<"_All_SpecialScenarios"; std::string pdfname8 = pdfname8ss.str();
