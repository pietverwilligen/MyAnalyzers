...
void RedPercent_2D_StaMuonHits_2012() {
    ...
    std::string label2 = "CMSSW 53X (2012 Geometry)"; 
    ...
    std::string info3 = "Sample used: SingleMu/Run2012D";
    ...
    std::string RootFileName2 = "STAMuon_53X_2012.root";
    ...
    */
    ...
    y_range_2 = 15.00;
    std::stringstream pdfname2ss; pdfname2ss<<"STAMuonHits_2D_2012_"<<"RedPercent"<<"_All"; std::string pdfname2 = pdfname2ss.str(); 
    ...
    latex_cmslab.DrawLatex(0.05, 0.925,"CMS #sqrt{s} = 8 TeV"); latex_cmslab.DrawLatex(0.70, 0.925, label2.c_str()); gPad->RedrawAxis(); latex_cmslab.DrawLatex(0.125, 0.85, "All");
    ...
    y_range_2 = 10.00;
    std::stringstream pdfname3ss; pdfname3ss<<"STAMuonHits_2D_2012_"<<"RedPercent"<<"_RPC"; std::string pdfname3 = pdfname3ss.str(); 
    ...
    latex_cmslab.DrawLatex(0.05, 0.925,"CMS #sqrt{s} = 8 TeV"); latex_cmslab.DrawLatex(0.70, 0.925, label2.c_str()); gPad->RedrawAxis(); latex_cmslab.DrawLatex(0.125, 0.85, "RPC");
    ...
    y_range_2 = 10.00;
    std::stringstream pdfname4ss; pdfname4ss<<"STAMuonHits_2D_2012_"<<"RedPercent"<<"_DT"; std::string pdfname4 = pdfname4ss.str(); 
    ...
    latex_cmslab.DrawLatex(0.05, 0.925,"CMS #sqrt{s} = 8 TeV"); latex_cmslab.DrawLatex(0.70, 0.925, label2.c_str()); gPad->RedrawAxis(); latex_cmslab.DrawLatex(0.125, 0.85, "DT");
    latex_info.DrawLatex(infoX_x_right, info1_y, info1.c_str()); latex_info.DrawLatex(infoX_x_right, info2_y, info2.c_str()); latex_info.DrawLatex(infoX_x_right, info3_y, info3.c_str());
    savePlot(c4, pdfname4.c_str());

    y_range_2 = 10.00;
    std::stringstream pdfname5ss; pdfname5ss<<"STAMuonHits_2D_2012_"<<"RedPercent"<<"_CSC"; std::string pdfname5 = pdfname5ss.str(); 
    ...
    latex_cmslab.DrawLatex(0.05, 0.925,"CMS #sqrt{s} = 8 TeV"); latex_cmslab.DrawLatex(0.70, 0.925, label2.c_str()); gPad->RedrawAxis(); latex_cmslab.DrawLatex(0.125, 0.85, "CSC");
    ...
    std::stringstream pdfname6ss; pdfname6ss<<"STAMuonHits_2D_2012_"<<"RedPercent"<<"_Eff_1SegRemoved_All"; std::string pdfname6 = pdfname6ss.str();
    ...
    latex_cmslab.DrawLatex(0.10, 0.925,"CMS #sqrt{s} = 8 TeV"); latex_cmslab.DrawLatex(0.70, 0.925, label2.c_str()); gPad->RedrawAxis(); latex_cmslab.DrawLatex(0.125, 0.85, "All");
