...
void Compare_STAMuonHits_AllHits_2015vs2023() {
    ...
    // ----------------------
    std::string info1 = "All individual hits of the Stand Alone Muon";
    ...
    */
    ...
    std::stringstream pdfname2ss; pdfname2ss<<"Compare_STAMuonHits_AllHits_"<<title<<"_All"; std::string pdfname2 = pdfname2ss.str(); 
    ...
    std::stringstream pdfname3ss; pdfname3ss<<"Compare_STAMuonHits_AllHits_"<<title<<"_RPC"; std::string pdfname3 = pdfname3ss.str(); 
    ...
    std::stringstream pdfname4ss; pdfname4ss<<"Compare_STAMuonHits_AllHits_"<<title<<"_DT"; std::string pdfname4 = pdfname4ss.str(); 
    ...
    std::stringstream pdfname5ss; pdfname5ss<<"Compare_STAMuonHits_AllHits_"<<title<<"_CSC"; std::string pdfname5 = pdfname5ss.str(); 
