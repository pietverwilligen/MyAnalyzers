...
void Simulate_Redundancy_2015_Final() {
    ...
    */
    ...
    latex_cmslab.DrawLatex(0.075, 0.925,"CMS Phase 1 Simulation Preliminary"); /*#sqrt{s} = 13 TeV*/ /*latex_cmslab.DrawLatex(0.70, 0.925, label2.c_str());*/ gPad->RedrawAxis(); // latex_cmslab.DrawLatex(0.125, 0.85, "All");
    ...
    TightIDEff->Draw("HP");
    Efficiency_1D_Plot[0]->Draw("HPSame"); Efficiency_1D_Plot[1]->Draw("HPSame"); /*Efficiency_1D_Plot[2]->Draw("HPSame");*/ Efficiency_1D_Plot[3]->Draw("HPSame"); /*Efficiency_1D_Plot[4]->Draw("HPSame");*/ 
    latex_cmslab.DrawLatex(0.10, 0.925,"CMS Phase 1 Simulation Preliminary"); /*#sqrt{s} = 13 TeV*/ /*latex_cmslab.DrawLatex(0.575, 0.925, label2.c_str());*/ gPad->RedrawAxis(); // latex_cmslab.DrawLatex(0.125, 0.85, "All");
    TightIDEff->GetXaxis()->SetTitleOffset(x_title_offset_ineff); TightIDEff->GetYaxis()->SetTitleOffset(y_title_offset_ineff);
    TightIDEff->GetXaxis()->SetTitle(xaxislabel_ineff.c_str());   TightIDEff->GetYaxis()->SetTitle(yaxislabel_ineff.c_str());
    TightIDEff->GetXaxis()->SetTitleSize(0.06);
    TightIDEff->GetYaxis()->SetRangeUser(y_range_1,y_range_2);
    ...
    latex_cmslab.DrawLatex(0.075, 0.925,"CMS Phase 1 Simulatin Preliminary"); /*#sqrt{s} = 13 TeV*/ /*latex_cmslab.DrawLatex(0.70, 0.925, label2.c_str()); gPad->RedrawAxis();*/ // latex_cmslab.DrawLatex(0.125, 0.85, "All");
    TightIDEff->GetXaxis()->SetTitleOffset(x_title_offset_ineff); TightIDEff->GetYaxis()->SetTitleOffset(y_title_offset_ineff);
    TightIDEff->GetXaxis()->SetTitle(xaxislabel_ineff.c_str());   TightIDEff->GetYaxis()->SetTitle(yaxislabel_ineff.c_str());
    TightIDEff->GetXaxis()->SetTitleSize(0.06);
    TightIDEff->GetYaxis()->SetRangeUser(y_range_1,y_range_2);
