...
void RedPercent_2D_StaMuonHits_2023() {
    ...
    */
    ...
    std::stringstream pdfname6ss; pdfname6ss<<"STAMuonHits_2D_2023_"<<"RedPercent"<<"_Eff_1SegRemoved_All"; std::string pdfname6 = pdfname6ss.str();
