...
void Extract_2D_StaMuonHits_2015() {
    ...
    std::string zaxislabel = "Total Amount of Hits";
    ...
    */
    ...
    y_range_2 = 15.00;
    std::stringstream pdfname2ss; pdfname2ss<<"STAMuonHits_2D_2015_"<<"_All"; std::string pdfname2 = pdfname2ss.str(); 
    ...
    y_range_2 = 10.00;
    std::stringstream pdfname3ss; pdfname3ss<<"STAMuonHits_2D_2015_"<<"_RPC"; std::string pdfname3 = pdfname3ss.str(); 
    ...
    y_range_2 = 10.00;
    std::stringstream pdfname4ss; pdfname4ss<<"STAMuonHits_2D_2015_"<<"_DT"; std::string pdfname4 = pdfname4ss.str(); 
    ...
    y_range_2 = 10.00;
    std::stringstream pdfname5ss; pdfname5ss<<"STAMuonHits_2D_2015_"<<"_CSC"; std::string pdfname5 = pdfname5ss.str(); 
