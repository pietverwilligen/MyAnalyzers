...
# prefix = 'file:'
# dirname = ''
# dirname = '/user/piet/MC2010/Fall10MC/GJets_HT-200_madgraph_Fall10/'
### mX SE
###------
# prefix = 'dcap://'
...
process.source = cms.Source("PoolSource",
 ...
 'file:/user/piet/CMSSW_Versions/Photon/DATA/PhotonJets_Pt200toInf-madgraph_Summer10_1_1_urI.root'
     )
 )
...
process.phanlzr = cms.EDAnalyzer('PhotonAnalyzer',
                              ...
                              RootFileName = cms.string("GJets_HT-200_madgraph_Fall10.root"),
