...
prefix = 'file:'
# dirname = ''
# dirname = '/user/piet/Ph2010/Dec10Processing/EGRun2010A-Nov4ReReco_v1/'
dirname = '/user/piet/Ph2010/Jan11Processing/EGRun2010A-Nov4ReReco_v1/'
### mX SE
###------
# prefix = 'dcap://'
...
process.phanlzr = cms.EDAnalyzer('PhotonAnalyzer',
                              ...
                              RootFileName = cms.string("EGRun2010A-Nov4ReReco.root"),
...
process.p = cms.Path(process.ra2PostCleaning * process.ra2PFElectrons * process.ra2PFElectronVeto * process.phanlzr * process.lumiJSON)
