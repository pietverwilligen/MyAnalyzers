...
# DATA process.GlobalTag.globaltag = cms.string('GR_R_38X_V15::All')
...
prefix = 'file:'
# dirname = ''
dirname = '/user/piet/MC2010/Fall10MC/TTJets_madgraph-tauola_Fall10/'
### mX SE
###------
# prefix = 'dcap://'
...
process.phanlzr = cms.EDAnalyzer('PhotonAnalyzer',
                              ...
                              EGMIsolation = cms.bool(False),
                               AmountOfJets = cms.int32(3),
                              RootFileName = cms.string("TTJets_madgraph-tauola_Fall10.root"),
