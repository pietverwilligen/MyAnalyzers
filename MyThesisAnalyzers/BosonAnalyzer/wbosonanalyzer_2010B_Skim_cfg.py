...
# prefix = 'dcap://'
dirname = '/data/lowette/SearchSkim/Mu_Run2010B-Nov4ReReco_v1_146428-149294/'
filenames = glob.glob(dirname + 'controlskim_nomuiso*.root')
INPUT_FILES = []
...
process.phanlzr = cms.EDAnalyzer('BosonAnalyzer',
			      ...
			      AmountOfJets = cms.int32(3),
                              RootFileName = cms.string("MuRun2010B-Nov4ReReco_v1_3j.root"),
