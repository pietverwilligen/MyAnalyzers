...
dirname = '/pnfs/iihe/cms/store/user/piet/Fall10MC/Winvisible2Jets_7TeV-madgraph_Fall10/'
...
process.phanlzr = cms.EDAnalyzer('BosonAnalyzer',
			      ...
			      AmountOfJets = cms.int32(2),
                              RootFileName = cms.string("WinvisibleJets_7TeV-madgraph_Fall10_100GeV.root"),
