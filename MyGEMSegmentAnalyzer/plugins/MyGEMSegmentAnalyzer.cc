// -*- C++ -*-
//
// Package:    MyGEMSegmentAnalyzer
// Class:      MyGEMSegmentAnalyzer
// 
/**\class MyGEMSegmentAnalyzer MyGEMSegmentAnalyzer.cc MyAnalyzers/MyGEMSegmentAnalyzer/src/MyGEMSegmentAnalyzer.cc
...
// Added functionalities: Piet Verwilligen
...
class MyGEMSegmentAnalyzer : public edm::EDAnalyzer {
   public:
      explicit MyGEMSegmentAnalyzer(const edm::ParameterSet&);
      ~MyGEMSegmentAnalyzer();
...
//
MyGEMSegmentAnalyzer::MyGEMSegmentAnalyzer(const edm::ParameterSet& iConfig)
...
MyGEMSegmentAnalyzer::~MyGEMSegmentAnalyzer()
{
  GE11_fitchi2->Write();
  GE11_fitndof->Write();
...
void
MyGEMSegmentAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
DEFINE_FWK_MODULE(MyGEMSegmentAnalyzer);
