...
process.source = cms.Source("PoolSource",
            ...
            # =====   CMSSW 6 2 0 SLHC5  =====
            'file:/build/piet/Upgrade/Eta_2p4_Releases/CMSSW_6_2_0_SLHC5/src/MyCmsDriverCommands/SingleMuPt100_1p6_2p1_cfi_GEN-SIM.root'
            )
)

process.demo = cms.EDAnalyzer('MyREn1SimHitAnalyzer',
                              RootFileName = cms.untracked.string("MyREn1SimHistograms_SingleMuPt100_eta1p16_eta2p1.root"),
