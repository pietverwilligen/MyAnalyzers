...
process.demo = cms.EDAnalyzer('MyME11SimHitAnalyzer',
                              # ---------
                              ...
                              # ---------
                              PdfFileNameBase = cms.untracked.string("MyME11SimHistograms_Phase1_2023DB_Neutron_XS_1E4s"),
                              RootFileName = cms.untracked.string("MyME11SimHistograms_Phase1_2023DB_Neutron_XS_1E4s.root"),
                              # ---------
